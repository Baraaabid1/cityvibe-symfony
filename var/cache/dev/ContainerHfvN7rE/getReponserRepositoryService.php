 ...
 */
class getReponserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReponserRepository' shared autowired service.
     *
     * @return \App\Repository\ReponserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReponserRepository.php';

        return $container->privates['App\\Repository\\ReponserRepository'] = new \App\Repository\ReponserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
